...
deploy_image() {
    ...
    docker push  526262051452.dkr.ecr.us-east-1.amazonaws.com/ecs-circleci-einsteinish:$CIRCLE_SHA1 |cat
...
make_task_def() {
    ...
    task_template='[
	{
	    ...
	    "image": "526262051452.dkr.ecr.us-east-1.amazonaws.com/ecs-circleci-einsteinish:%s",
	    "essential": true,
	    "memory": 200,
	    "cpu": 10
	},
